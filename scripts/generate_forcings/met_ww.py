...
with h5py.File(basepath + '/data/ww_spinup.h5', 'w') as hf:
...
with h5py.File(basepath + '/data/ww_irrigation.h5', 'w') as hf:
    hf.create_dataset('time [s]', data=tim)
    hf.create_dataset('air temperature [K]', data=t+273.15)
    hf.create_dataset('incoming shortwave radiation [W m^-2]', data=swin)
...
with h5py.File(basepath + '/data/ww_control.h5', 'w') as hf:
    hf.create_dataset('time [s]', data=tim)
    hf.create_dataset('air temperature [K]', data=t+273.15)
    hf.create_dataset('incoming shortwave radiation [W m^-2]', data=swin)
...
# with h5py.File(basepath + '/data/ww_irrigation_multi.h5', 'w') as hf:
#     hf.create_dataset('time [s]', data=tim)
#     hf.create_dataset('air temperature [K]', data=t+273.15)
#     hf.create_dataset('incoming shortwave radiation [W m^-2]', data=swin)
...
# hf.close()
# 
# with h5py.File(basepath + '/data/ww_irrigation_50more.h5', 'w') as hf:
#     hf.create_dataset('time [s]', data=tim)
#     hf.create_dataset('air temperature [K]', data=t+273.15)
#     hf.create_dataset('incoming shortwave radiation [W m^-2]', data=swin)
...
# hf.close()
# 
# with h5py.File(basepath + '/data/ww_irrigation_50less.h5', 'w') as hf:
#     hf.create_dataset('time [s]', data=tim)
#     hf.create_dataset('air temperature [K]', data=t+273.15)
#     hf.create_dataset('incoming shortwave radiation [W m^-2]', data=swin)
...
# hf.close()
# 
# with h5py.File(basepath + '/data/ww_irrigation_multi4.h5', 'w') as hf:
#     hf.create_dataset('time [s]', data=tim)
#     hf.create_dataset('air temperature [K]', data=t+273.15)
#     hf.create_dataset('incoming shortwave radiation [W m^-2]', data=swin)
...
# with h5py.File(basepath + '/data/ww_irrigation_grad.h5', 'w') as hf:
#     hf.create_dataset('time [s]', data=tim)
#     hf.create_dataset('air temperature [K]', data=t+273.15)
#     hf.create_dataset('incoming shortwave radiation [W m^-2]', data=swin)
#     hf.create_dataset('precipitation rain [m s^-1]', data=rr_i/86400000)
